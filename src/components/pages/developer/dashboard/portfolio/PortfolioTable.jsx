...
const PortfolioTable = ({isLoading, isFetching, portfolio, setItemEdit}) => {
  ...
  return (
    ...
    {store.isActive && <ModalConfirm position="center" queryKey="portfolio" endpoint={`/v1/portfolio/active/${id}`} 
        isArchiving={isArchiving}/>}

    {store.isDelete && <ModalDelete position="center" endpoint={`/v1/portfolio/${id}`} 
    queryKey="portfolio"/>}
